$(document).ready(function() { /*$(document) q voy a trabajar con jqury */
    ...
    if (form_name != null && form_name != "undefined") { //si tiene algo entro
        var about_parrafo = $("#detalle p"); //selecciono este div con el parrafo y lo guardo en la variable
    ...
    if (window.location.href.indexOf('detalle') > -1) { //cuando estoy en la pagina detalle
        $("#acordeon").accordion(); //tiro la propiedad de jquery ui el acordeon
    }

    if (window.location.href.indexOf('detalle') > -1) { //cuando estoy en la pagina detalle
        $("#acordeon2").accordion(); //tiro la propiedad de jquery ui el acordeon
    }
